...
export class LobbyView {
  ...
  constructor(controller: LobbyController, runtimeApi: LobbyRuntimeApi, callbacks: LobbyViewCallbacks) {
    ...
    const heroBody = createElement(
      "p",
      "hero-panel__body",
      "末日废土中的战利品争夺战。组建你的小队，进入危险区域，搜刮物资并活着撤离。",
    );
    ...
    actionCard.append(
      createElement("p", "panel__eyebrow", "LOGIN"),
    ...
    nameLabel.append(
      createElement("span", "field__label", "代号 / AGENT NAME"),
    );
    ...
    roomHeadingText.append(
      createElement("p", "panel__eyebrow", "COMMUNICATION"),
    ...
    playersWrap.append(
      createElement("div", "section-heading", "ROSTER"),
    );
    ...
    this.leaveButton = createElement("button", "button button--ghost", "断开连接") as HTMLButtonElement;
    ...
    if (!roomState) {
      ...
      this.playerList.replaceChildren(
        createElement(
          ...
          "Waiting for team authorization...",
        ),
      );
