...
- Browser/mobile hands-on comfort: the lobby now uses a stacked mobile layout on a 390px viewport, verified by a Chromium screenshot, and the settlement overlay now has dedicated mobile single-column and scroll rules; the remaining surfaces still need a dedicated responsive pass for full play comfort.
