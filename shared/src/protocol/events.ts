export const SocketEvent = {
  ...
  PlayerMoveItem: "player:moveItem",
  ...
  SpawnPhaseChanged: "spawn:phaseChanged",
  MusicMode: "music:mode",
  MonsterProjectileSpawn: "monsterProjectile:spawn",
  MonsterProjectileHit: "monsterProjectile:hit",
  MonsterProjectileDespawn: "monsterProjectile:despawn",
